...
class Email(models.Model):
    ...
    def send(self):
        ...
        ## HACK for testing full flow before launch
        recipients = ["%s <%s>" % (self.to_person.name, "jd@openup.org.za") for c in self.to_person.contactdetails.filter(type='email').all()] + ["greg@openup.org.za"]
